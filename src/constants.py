...
SUPPORT_BUTTONS = {
    ...
    2: f"{emoji.emojize(':ticket:')} Прийти на спектакль",
    3: f"{emoji.emojize(':thumbs_up:')} Партнерство",
    4: f"{emoji.emojize(':thumbs_up:')} Заказать суверниры",
    5: f"{emoji.emojize(':thumbs_up:')} Стать спонсором",
    6: f"{emoji.emojize(':thumbs_up:')} Стать волонтером",
    7: f"{emoji.emojize(':thumbs_up:')} Стать подписчиком социальных сетей",
