...
MAIN_TEXT = 'Привет! Познакомимся?' \
            ...
            'Мы верим: каждый человек — творец, ' \
            'каждый уникален и выразителен, ' \
            'каждый имеет право делиться творчеством с другими. ' \
            'Мы знаем: искусство — это способ ' \
            'взаимодействия с собой и миром. ' \
            'Мы посвящаем свою деятельность социокультурной ' \
            'реабилитации и социальной интеграции людей с ' \
            'особыми возможностями, содействуем раскрытию их ' \
            'творческого потенциала, повышению социального ' \
