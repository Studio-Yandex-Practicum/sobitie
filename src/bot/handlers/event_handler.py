...
from bot.convers_func.event_conversation import (get_events, get_perfomances, get_master_classes)
...
event_conv = ConversationHandler(
    ...
    states={
        CHOOSE_EVENT: [
            ...
            CallbackQueryHandler(get_master_classes, pattern='^' + GET_MASTER_CLASS + '$'),
        ]
    },
