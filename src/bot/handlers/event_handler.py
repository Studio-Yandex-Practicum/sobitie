...
from bot.convers_func.event_conversation import get_events, get_master_classes, get_performances
...
event_conv = ConversationHandler(
    ...
    states={
        CHOOSE_EVENT: [
            CallbackQueryHandler(get_performances, pattern="^" + GET_PERFORMANCES + "$"),
